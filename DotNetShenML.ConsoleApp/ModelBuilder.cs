...
using DotNetShenML.Model;

namespace DotNetShenML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\ailun\source\repos\DotNetShen\TestSandbox\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../DotNetShenML.Model/MLModel.zip";
